...
class ConvReLU(nn.Module):
    ...
    """
    def __init__(self, in_c, out_c, kernel_size:int = 3, padding:int = 1):
        super().__init__()
...
class EncoderBlock(nn.Module):
    def __init__(self, in_c, out_c, depth:int = 2, kernel_size:int = 3, padding:int = 1):
        super().__init__()
        ...
        # final pooling operation, with return_indices to return the max indices along with
        # the outputs
